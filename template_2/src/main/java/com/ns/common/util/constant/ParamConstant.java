...
public interface ParamConstant {
    ...
    interface Key {
        String JEDIS_MAX_ACTIVE = "JEDIS_MAX_ACTIVE";
        String JEDIS_MAX_IDLE = "JEDIS_MAX_IDLE";
        String JEDIS_MAX_WAIT = "JEDIS_MAX_WAIT";
        String JEDIS_TEST_ON_BORROW = "JEDIS_TEST_ON_BORROW";
        ...
        String JPUSH_DRIVER_MASTER_SECRET = "JPUSH_DRIVER_MASTER_SECRET";
        String JPUSH_DRIVER_APP_KEY = "JPUSH_DRIVER_APP_KEY";
        String JPUSH_SHIPPER_MASTER_SECRET = "JPUSH_SHIPPER_MASTER_SECRET";
        String JPUSH_SHIPPER_APP_KEY = "JPUSH_SHIPPER_APP_KEY";
